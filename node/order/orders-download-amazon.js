	...
	do {
		...
		try {
			...
			if (!saveToDBOnly) {
				...
				// var requestReportResponse = await requestReport({
				// 	'ReportType': '_GET_FLAT_FILE_ACTIONABLE_ORDER_DATA_'
				// });
				// if (requestReportResponse instanceof Error) {
				// 	throw requestReportResponse;
				// }
				// console.log(JSON.stringify(requestReportResponse));

				/*var getReportRequestListResponse = await getReportRequestList({
					'ReportProcessingStatusList': '_DONE_'
				});
				console.log(getReportRequestListResponse);*/
				var listOrdersResponse = await listOrders({
					'MarketplaceId': {
						'Id': {
							1: 'A39IBJ37TRP1C6'
						}
					...
					'LastUpdatedAfter': '2019-05-01T13:00:00'
					//'LastUpdatedBefore': '2019-04-15T14:00:00'
				});
				console.log(listOrdersResponse);

				// var orders = [
				// 	{
				// 		'order-id': '250-9266983-3426220',
				// 		'order-item-id': '41483244219702',
				// 		'purchase-date': '2018-07-24T23:36:18+00:00',
				// 		'payments-date': '2018-07-24T23:36:18+00:00',
				// 		'reporting-date': '2018-07-24T23:39:36+00:00',
				// 		'promise-date': '2018-07-27T13:59:59+00:00',
				// 		'days-past-promise': '-2',
				// 		'buyer-email': 'q77l6xlf2zr6rzq@marketplace.amazon.com.au',
				// 		'buyer-name': 'John Burstow',
				// 		'buyer-phone-number': '0449704054',
				// 		'sku': '1122',
				// 		'product-name': 'New 1KG Vital Greens Food Supplement Nutrient Superfood Organic Antioxidant',
				// 		'quantity-purchased': '3',
				// 		'quantity-shipped': '0',
				// 		'quantity-to-ship': '3',
				// 		'ship-service-level': 'Standard',
				// 		'recipient-name': 'John Burstow',
				// 		'ship-address-1': '4 Howard St',
				// 		'ship-address-2': '',
				// 		'ship-address-3': '',
				// 		'ship-city': 'MORNINGSIDE',
				// 		'ship-state': 'QLD',
				// 		'ship-postal-code': '4170',
				// 		'ship-country': 'AU'
				// 	},
				// 	{ 
				// 		'order-id': ''
...
async function amazonRequest(action, path, options) {
	...
	var requestParams = { // Alphabetical order for signing
		AWSAccessKeyId: 'AKIAIAFIEGE6EJM5VQ4Q',
