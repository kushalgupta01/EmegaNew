...
const loadStockBayStage = async function(req, res, next) {
	...
	try {
		do {
			...
			var sql = 'SELECT bay FROM inventorylocation WHERE bay LIKE "STAGE%" GROUP BY bay ORDER BY LENGTH(bay), bay';
			await conn.connect();
...
module.exports = loadStockBayStage;