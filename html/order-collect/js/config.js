...
window.stores = {
	...
	'64': {
		id: 'sonsofamazonshopify',
		name: 'SonsOfAmazonShopify',
		service: SERVICE_IDS.SHOPIFY,
		storeID: 'SOAS',
		recID: 'SOAS-',
		checkPayment: false,
    ...
    '92': {
        id: 'trinityconnect_catch',
        name: 'Trinityconnect Catch',
        service: SERVICE_IDS.CATCH,
        storeID: 'TCC',
        recID: 'TCC-',
        checkPayment: false,
    ...
    '75': {
        id: 'trinityconnect_kogan',
        name: 'Trinityconnect Kogan',
        service: SERVICE_IDS.KOGAN,
        storeID: 'TCK',
        recID: 'TCK-',
		checkPayment: false,
...
window.ORDER_STATUS_NAME = {
	...
	19: 'Warehouse Collected',
	20: 'Partial Collected',
	21: 'Partially Picked',
	22: 'Fully Picked',
	23: 'Delivered',
};
...
window.ORDER_DATA = {
	...
	HABITANIA: 'habit',
	CATWALK: 'cw',
	PARTIALLYPICKED: 'partpick',
	FULLYPICKED: 'fullpick',
	SONSOFAMAZON: 'soa',
	AUTOWELL: 'autowell',
	TRINITYCONNECT: 'tc',
	CIRCULAR2NDS: 'c2',
...
PAGE_TAB_INFO[PAGE_TAB.FASTWAYFLATPACK5KG] = {
	name: 'Fastway Medium', id: 'tab-fastwayflatpack5kg', href: '#fastwayflatpack5kg'
};
...
PAGE_TAB_INFO[PAGE_TAB.JV] = {
	name: 'JV', id: 'tab-jv', href: '#jv'
};
...
PAGE_TAB_INFO[PAGE_TAB.LPG] = {
	name: 'LPG', id: 'tab-lpg', href: '#lpg'
};
...
PAGE_TAB_INFO[PAGE_TAB.HOBEXPRESS] = {
	name: 'HobExp', id: 'tab-hobbycoexpress', href: '#hobexp', supplier: 'HOBBYCO', class:'hobbyco',
};
PAGE_TAB_INFO[PAGE_TAB.QUARANTINE] = {
	name: 'Quarantine', id: 'tab-quarantine', href: '#qurantine', supplier: 'HOBBYCO', class:'hobbyco',
};
...
// PAGE_TAB_INFO[PAGE_TAB.B2BWholesale] = {
// 	name: 'B2B Wholesale', id: 'tab-b2bw', href: '#b2bw'
// };
// PAGE_TAB_INFO[PAGE_TAB.B2BTransfer] = {
// 	name: 'B2B Transfer', id: 'tab-b2bt', href: '#b2bt'
// };
PAGE_TAB_INFO[PAGE_TAB.B2BORDERS] = {
	name: 'B2B Orders', id: 'tab-b2bord', href: '#b2bord'
};

PAGE_TAB_INFO[PAGE_TAB.ME] = {
	name: 'ME', id: 'tab-me', href: '#me'
};

PAGE_TAB_INFO[PAGE_TAB.HABITANIA] = {
	name: 'HABITANIA', id: 'tab-habit', href: '#habit', supplier: 'HABITANIA', class:'habitania',
};
PAGE_TAB_INFO[PAGE_TAB.CATWALK] = {
	name: 'CATWALK', id: 'tab-cw', href: '#cw', supplier: 'CATWALK', class:'catwalk',
};

PAGE_TAB_INFO[PAGE_TAB.PARTIALLYPICKED] = {
	name: 'Partially Picked', id: 'tab-partpick', href: '#partpick', status: 21,
};
PAGE_TAB_INFO[PAGE_TAB.FULLYPICKED] = {
	name: 'Fully Picked', id: 'tab-fullpick', href: '#fullpick', status: 22,
};
PAGE_TAB_INFO[PAGE_TAB.SONSOFAMAZON] = {
	name: 'SONSOFAMAZON', id: 'tab-soa', href: '#soa', supplier: 'SonsOfAmazon', class:'soa',
};
PAGE_TAB_INFO[PAGE_TAB.AUTOWELL] = {
	name: 'Autowell', id: 'tab-aw', href: '#aw', supplier: 'AUTOWELL', class: 'autowell'
};
PAGE_TAB_INFO[PAGE_TAB.TRINITYCONNECT] = {
	name: 'Trinityconnect', id: 'tab-tc', href: '#tc', supplier: 'TRINITYCONNECT', class: 'tc'
};
PAGE_TAB_INFO[PAGE_TAB.CIRCULAR2NDS] = {
	name: 'Circular2nds', id: 'tab-c2', href: '#c2', supplier: 'RRV', class: 'c2'
};
PAGE_TAB_INFO[PAGE_TAB.RRV] = {
	name: 'RRV', id: 'tab-rrv', href: '#rrv', supplier: 'RRV', class: 'rrv'
};
PAGE_TAB_INFO[PAGE_TAB.SWD] = {
	name: 'SWD', id: 'tab-swd', href: '#swd', supplier: 'SWD', class: 'swd'
};
PAGE_TAB_INFO[PAGE_TAB.HPD] = {
	name: 'HPD', id: 'tab-hpd', href: '#hpd', supplier: 'HPD', class: 'hpd'
};
PAGE_TAB_INFO[PAGE_TAB.ELIABATHROOMS] = {
	name: 'ELIABATHROOMS', id: 'tab-eli', href: '#eli', supplier: 'eliabathrooms'
};
PAGE_TAB_INFO[PAGE_TAB.SPARTAN] = {
	name: 'SPARTAN', id: 'tab-spa', href: '#spa', supplier: 'spartan'
};
PAGE_TAB_INFO[PAGE_TAB.DEAL] = {
	name: 'DEAL', id: 'tab-de', href: '#de'
};

PAGE_TAB_INFO[PAGE_TAB.HUGGIES] = {
	name: 'HUGGIES', id: 'tab-hug', href: '#hug'
};
PAGE_TAB_INFO[PAGE_TAB.FINISH] = {
	name: 'FINISH', id: 'tab-fin', href: '#fin'
};
PAGE_TAB_INFO[PAGE_TAB.ORALB] = {
	name: 'ORALB', id: 'tab-ora', href: '#ora'
};
PAGE_TAB_INFO[PAGE_TAB.ATPACK] = {
	name: 'ATPACK', id: 'tab-ap', href: '#ap'
};
PAGE_TAB_INFO[PAGE_TAB.PACOJAANSON] = {
	name: 'PACOJAANSON', id: 'tab-pac', href: '#pac', supplier: 'pacojaanson', class: 'pac'
};
PAGE_TAB_INFO[PAGE_TAB.ICTONE] = {
	name: 'ICTONE', id: 'tab-ict', href: '#ict', supplier: 'pacojaanson', class: 'pac'
};
...
PANEL_INFO[PANEL_TYPE.DELIVERE] = {
	name: 'DeliverE',
	id: 'template-delivere',
	types: [ORDER_TYPE.DELIVERE],
};
...
SUPPLIER_INFO[SUPPLIER.SonsOfAmazon] = {
	id: 'sonsofamazon',
	name: 'Sons of Amazon',
	stores: ['64','16'],
}
SUPPLIER_INFO[SUPPLIER.AUTOWELL] = {
	id: 'autowell',
	name: 'Autowell',
	stores: ['101'],
}
SUPPLIER_INFO[SUPPLIER.TRINITYCONNECT] = {
	id: 'trinityconnect',
	name: 'Trinityconnect',
	stores: ['75','92','65','4','103'],
}
SUPPLIER_INFO[SUPPLIER.RRV] = {
	id: 'rrv',
	name: 'RRV',
	stores: ['1','102'],
}
SUPPLIER_INFO[SUPPLIER.EMEGA] = {
	id: 'emega',
	name: 'EMEGA',
	stores: ['1','51','93'],
}
SUPPLIER_INFO[SUPPLIER.ATPACK] = {
	id: 'atpack',
	name: 'At Pack',
	stores: ['106'],
}
SUPPLIER_INFO[SUPPLIER.PACOJAANSON] = {
	id: 'pacojaanson',
	name: 'Paco Jaanson',
	stores: ['1'],
}
