	...
	onMessageReceived(data) {
		...
		for (let entry of dataEntries) {
			...
			if (entry.action == LIVE_ACTIONS.RECORD_OPENED) {
				...
				else if (entry.status == 'lpg') {
					recordItem.classList.add('lpg');
				}
				...
				}else if (entry.status == 'me') {
					recordItem.classList.add('me');
				}
				...
				else if (entry.status == 'jv') {
					recordItem.classList.add('jv');
				}
				...
				else if (entry.status == 'alternative') {
					recordItem.classList.add('alternative');
				}
				else if (entry.status == ORDER_STATUS.PARTIALCOLLECT) {
					recordItem.classList.add('partialcollect');
				}
				else if (entry.status == 'collect') {
					recordItem.classList.add('collect');
				}
				else if (entry.status == 'warehousecollect') {
					recordItem.classList.add('warehousecollect');
				}
				else {
