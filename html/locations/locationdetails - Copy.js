		...
		var tr = document.createElement('tr');
	 	...
	 	for (let col of cols) {
        	...
        	if (col == 'locations') {
                ...
                viewBtn.setAttribute('value', checkLocat);
...
async function executeTransfer(){
    ...
    if (document.getElementById('sts-dispatch').checked == true) {
        ...
        let checkDestination = document.getElementById('location-input-target').value;
        checkDestination = checkDestination.toLowerCase();
        if (checkDestination.startsWith('emg-')){
        }
        else {
            document.getElementById("location-input-target").value = 'EMG-'+document.getElementById("location-input-target").value;
        }
    }
    ...
    if (checkDestination.startsWith('emg-') && document.getElementById('sts-newWarehouse').checked !== true){
    ...
    if (r == false) {
        if (confirm('Bay not found! Would you like to create '+destination+' as a new location') == true){
