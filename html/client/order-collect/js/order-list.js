	...
	for (let store in stores) {
		...
		for (let recordNum of recordNums) {
			...
			if (rowDataToday.constructor == Object) {
				...
				else if (page.type == PAGE_TYPE.COLLECT || page.type == PAGE_TYPE.PARTIALCOLLECT || page.type == PAGE_TYPE.WAREHOUSECOLLECT || page.type == PAGE_TYPE.AWAITINGLIST || page.type == PAGE_TYPE.RTS || page.type == PAGE_TYPE.ORDERED || page.type == PAGE_TYPE.REFUNDS) {
