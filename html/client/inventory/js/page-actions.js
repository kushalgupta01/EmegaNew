...
function showTab(data = {}) {
	...
	if (tabID==null) {
		if (page.type == PAGE_TYPE.COLLECT || page.type == PAGE_TYPE.AWAITINGLIST  || page.type == PAGE_TYPE.ORDERED) {
	...
	switch (tabID) {
		...
		case PAGE_TAB.AMAZON:
			...
			break;
		case PAGE_TAB.INTERTRADING:
			selectedOrderData[ORDER_DATA.INTERTRADING] = true;
			break;
		...
		case PAGE_TAB.MICROSOFT:
			...
			break;
		case PAGE_TAB.FGB:
			selectedOrderTypes[ORDER_TYPE.FGB] = true;
			selectedOrderData[ORDER_DATA.FGB] = true;
			break;
